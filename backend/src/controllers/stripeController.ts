      ...
      await createNotificationsBulk([
        {
          ...
          body: `Payment for booking ${payment.booking.id} completed successfully.`,
        ...
        },
        {
          ...
          body: `Payment for booking ${payment.booking.id} has been completed.`,
          link: "/account/payments",
        },
      ]);
        ...
        await createNotificationsBulk([
          {
            ...
            type: "PAYMENT",
            title: "Payment successful",
            body: `Payment for booking ${bookingId} completed successfully.`,
            link: "/account/payments",
          },
          {
            userId: payment.booking.babysitter.userId,
            type: "PAYMENT",
            title: "Payment received",
            body: `Payment for booking ${bookingId} has been completed.`,
            link: "/account/payments",
          },
        ]);
      } catch (notificationError) {
