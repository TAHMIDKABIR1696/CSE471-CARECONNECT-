          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12 order-2 lg:order-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className="flex items-center justify-center border-2 border-gray-300 rounded-lg p-3 cursor-pointer hover:border-purple-600 transition-colors">
                    <input type="radio" name="role" value="parent" className="mr-2" required />
                    <span>Parent</span>
                  </label>
                  <label className="flex items-center justify-center border-2 border-gray-300 rounded-lg p-3 cursor-pointer hover:border-purple-600 transition-colors">
                    <input type="radio" name="role" value="sitter" className="mr-2" required />
                    <span>Sitter</span>
                  </label>
                </div>
              </div>
