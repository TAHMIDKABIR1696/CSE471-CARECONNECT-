        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Personalized childcare and sitter services connecting families with trusted caregivers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/find-sitter" className="hover:text-purple-400 transition-colors">
                  Find a Sitter
                </Link>
              </li>
              <li>
                <Link to="/apply" className="hover:text-purple-400 transition-colors">
                  Become a Sitter
                </Link>
              </li>
              <li>
