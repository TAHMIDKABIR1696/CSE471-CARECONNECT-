...
const additionalCosts = [
  { service: "Background Check", cost: "Included in Premium+", basic: "$25 one-time" },
  { service: "Booking Fee", cost: "Waived", basic: "$5 per booking" },
  { service: "Cancellation Fee", cost: "None (24hr notice)", basic: "$10" },
];
      ...
      <div className="pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Choose the plan that fits your family&apos;s needs. All plans include
            access to verified, background-checked caregivers.
          </p>
        </div>
      </div>
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline">
                      ...
                      <span className="text-gray-600 ml-2">
                        /{plan.period === "Free Forever" ? "free" : "mo"}
                      </span>
                    </div>
