...
export default function ApplyPage() {
  ...
  const benefits = [
    { icon: DollarSign, title: "Competitive Pay", description: "Set your own rates and earn $15-30+ per hour" },
    { icon: Calendar, title: "Flexible Schedule", description: "Work when you want, choose your own hours" },
    { icon: Shield, title: "Safety First", description: "Background checks and insurance coverage included" },
    { icon: Users, title: "Great Families", description: "Connect with caring families in your area" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h1 className="text-5xl font-bold mb-6">Start Your Babysitting Career</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-500 transition-colors cursor-pointer">
                    <Upload className="mx-auto text-gray-400 mb-2" size={32} />
                    <p className="text-sm text-gray-600">Upload Certifications (CPR, First Aid, etc.)</p>
                  </div>
                </div>
              </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Application Review", desc: "We review your application within 24-48 hours" },
              { step: "2", title: "Background Check", desc: "Complete verification process and background screening" },
              { step: "3", title: "Profile Setup", desc: "Create your detailed caregiver profile" },
              { step: "4", title: "Start Working", desc: "Connect with families and begin earning" },
            ].map((item) => (
